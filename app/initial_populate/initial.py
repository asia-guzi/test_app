...
async def mark_as_initizlized() -> None:
    ...
    async with async_session() as session:
        try:
            session.add(DbCreated(creation_flag=True, creation_date=datetime.now()))
    ...
    questions = [
        {
            ...
            "answers": [("2", True), ("3", False), ("4", False), ("5", False)],
        },
        {
            "question": "What is 2 + 3?",
            "answers": [("5", True), ("4", False), ("6", False), ("7", False)],
        },
        {
            "question": "What is 5 - 2?",
            "answers": [("3", True), ("4", False), ("2", False), ("5", False)],
        },
        {
            "question": "What is 3 * 2?",
            "answers": [("6", True), ("5", False), ("7", False), ("8", False)],
        },
        {
            "question": "What is 10 - 4?",
            "answers": [("6", True), ("7", False), ("8", False), ("5", False)],
        },
        {
            "question": "What is 7 + 3?",
            "answers": [("10", True), ("11", False), ("12", False), ("9", False)],
        },
        {
            "question": "What is 6 / 2?",
            "answers": [("3", True), ("2", False), ("4", False), ("5", False)],
        },
        {
            "question": "What is 4 * 2?",
            "answers": [("8", True), ("6", False), ("9", False), ("7", False)],
        },
        {
            "question": "What is 9 - 5?",
            "answers": [("4", True), ("3", False), ("5", False), ("6", False)],
        },
        {
            "question": "What is 8 + 1?",
            "answers": [("9", True), ("10", False), ("8", False), ("11", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("10", True), ("9", False), ("8", False), ("11", False)],
        },
        {
            "question": "What is 20 - 10?",
            "answers": [("10", True), ("9", False), ("11", False), ("8", False)],
        },
        {
            "question": "What is 6 * 3?",
            "answers": [("18", True), ("17", False), ("19", False), ("15", False)],
        },
        {
            "question": "What is 2 + 2?",
            "answers": [("4", True), ("5", False), ("3", False), ("6", False)],
        },
        {
            "question": "What is 3 * 3?",
            "answers": [("9", True), ("8", False), ("10", False), ("7", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("1", True), ("0", False), ("2", False), ("3", False)],
        },
        {
            "question": "What is 8 * 1?",
            "answers": [("8", True), ("7", False), ("9", False), ("6", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("10", True), ("11", False), ("9", False), ("12", False)],
        },
        {
            "question": "What is 12 - 6?",
            "answers": [("6", True), ("5", False), ("7", False), ("4", False)],
        },
        {
            "question": "What is 4 + 4?",
            "answers": [("8", True), ("9", False), ("7", False), ("6", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("7", True), ("6", False), ("8", False), ("5", False)],
        },
        {
            "question": "What is 9 + 2?",
            "answers": [("11", True), ("10", False), ("12", False), ("13", False)],
        },
        {
            "question": "What is 5 * 2?",
            "answers": [("10", True), ("11", False), ("9", False), ("12", False)],
        ...
        },
        {
            ...
            "answers": [("7", True), ("6", False), ("8", False), ("9", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("15", True), ("14", False), ("16", False), ("13", False)],
        },
        {
        ...
        },
        {
            ...
            "answers": [("15", True), ("16", False), ("14", False), ("13", False)],
        },
        {
            "question": "What is 15 / 5?",
            "answers": [("3", True), ("2", False), ("4", False), ("5", False)],
        },
        {
            ...
            "answers": [("1", True), ("2", False), ("0", False), ("3", False)],
        },
        {
            "question": "What is 3 + 2?",
            "answers": [("5", True), ("4", False), ("6", False), ("7", False)],
        ...
        {
            "question": "What is 6 * 2?",
            "answers": [("12", True), ("10", False), ("14", False), ("11", False)],
        },
        {
        ...
        {
            "question": "What is 5 - 3?",
            "answers": [("2", True), ("4", False), ("3", False), ("1", False)],
        },
    ]
...
async def insert_user(nick: str) -> Optional[User]:
    """
